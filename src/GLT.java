...
public class GLT extends JFrame implements ActionListener
{
   ...
   private class GamePanel extends JPanel
   {
      ...
      public void paintComponent(Graphics g)
      {
         ...
         int drawX = (int) /*(ballX-ballWidth/2);//*/((ballX - lastBallX) * interpolation + lastBallX - ballWidth/2);
         int drawY = (int) /*(ballY-ballHeight/2);//*/((ballY - lastBallY) * interpolation + lastBallY - ballHeight/2);
